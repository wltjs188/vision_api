...
public class MainActivity extends AppCompatActivity {
    ...
    //이미지 url
    String imgurl="http://i.011st.com/ex_t/R/400x400/1/85/0/src/pd/19/3/8/1/0/4/3/bVzEj/2356381043_B.jpg";


    private static final String CLOUD_VISION_API_KEY = "AIzaSyAaYatWr1knKGmO_sAhy2j2xXLeNwjEuUM";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(){
            public void run(){
                Bitmap imgBitmap=toBitmap(imgurl);
                callCloudVision(imgBitmap);
                Bundle bun=new Bundle();
                bun.putParcelable("imgBitmap",imgBitmap);
    ...
    Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            Bitmap imgBitmap= bun.getParcelable("imgBitmap");
            mMainImage.setImageBitmap(imgBitmap);
        }
    };
